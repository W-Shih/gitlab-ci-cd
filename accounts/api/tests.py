...
# 16-Feb-2023  Wayne Shih              Initial create
# $HISTORY$
# =================================================================================================
...
#   to run tests.
# - It creates a test database, e.g. 'test_twitter', every time we run the test
...
class AccountApiTests(TestCase):
    ...
    def create_user(self, username, email, password):
        ...
        # because password needs to be hashed, also username and email need to be
        # normalized (e.g. trim).
        return User.objects.create_user(username, email, password)

    def test_drf_api_list_page(self):
        response = self.client.get(ACCOUNTS_BASE_URL)
    ...
    def test_login(self):
        ...
        # Test wrong password  <Wayne Shih> 16-Feb-2023
        ...
        # Test non exist user  <Wayne Shih> 16-Feb-2023
        response = self.client.post(LOGIN_URL, {
        ...
        # Test missing password  <Wayne Shih> 16-Feb-2023
        response = self.client.post(LOGIN_URL, {
            'username': self.user.username,
        })
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
        ...
        # Check now is at not login state  <Wayne Shih> 16-Feb-2023
        response = self.client.get(LOGIN_STATUS_URL)
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(response.data['has_logged_in'], False)

        # Test login successfully  <Wayne Shih> 16-Feb-2023
        response = self.client.post(LOGIN_URL, {
            'username': self.user.username,
            'password': 'correct_password',
        })
        ...
        # Check now is at login state  <Wayne Shih> 16-Feb-2023
        response = self.client.get(LOGIN_STATUS_URL)
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_logout(self):
        ...
        # Test if use GET to logout  <Wayne Shih> 16-Feb-2023
        response = self.client.get(LOGOUT_URL)
        self.assertEqual(response.status_code, status.HTTP_405_METHOD_NOT_ALLOWED)

        # Test if use POST to logout successfully  <Wayne Shih> 16-Feb-2023
    ...
    def test_signup(self):
        ...
        # Test if use GET to signup  <Wayne Shih> 16-Feb-2023
        response = self.client.get(SIGNUP_URL, data)
        self.assertEqual(response.status_code, status.HTTP_405_METHOD_NOT_ALLOWED)

        # Test wrong email format  <Wayne Shih> 16-Feb-2023
        ...
        # Test if password is too short (< 6)  <Wayne Shih> 16-Feb-2023
        response = self.client.post(SIGNUP_URL, {
            'username': 'someone',
            'email': 'someone@fb.com',
            'password': '123',
        ...
        # Test if username is too long (> 20)  <Wayne Shih> 16-Feb-2023
        response = self.client.post(SIGNUP_URL, {
        ...
        # Test if username has been occupied  <Wayne Shih> 16-Feb-2023
        response = self.client.post(SIGNUP_URL, {
            'username': self.user.username,
            'email': 'someone@google.com',
            'password': 'any_password',
        ...
        # Test if email has been occupied  <Wayne Shih> 16-Feb-2023
        response = self.client.post(SIGNUP_URL, {
            'username': 'someone',
        ...
        # Test signup successfully  <Wayne Shih> 16-Feb-2023
